...
@section('content')
 <div class="row col-md-9 col-lg-9 col-sm-9  pull-left">
   <h1>Update Company</h1>
      ...
      <div class="row col-md-12 col-lg-12 col-sm-12" style="background: #abc;margin: 10px">
...
<input placeholder="Enter name" id="company-name" name="name" spellcheck="false" 
 class="form-control"  value="{{$company->name}}"/>
                    </div>
             <div class="form-group">
               <label for="company-content">Description</label>
               <textarea placeholder="Enter Description" style="resize: vertical"
               id="company-content" name="description" rows="5" spellcheck="false"
